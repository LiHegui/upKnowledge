...
│   │       ├── JWT登录方案/
│   │       ├── 虚拟列表/
│   │       ├── 实时协同系统/  ← 专题目录（2026-07 CRDT/ 与 CRDT-讲解.md 合并去重迁入）
│   │       │   ├── index.md       ← 概览：挑战 / OT vs CRDT / 编辑器选型 / 架构安全
│   │       │   ├── CRDT原理.md     ← 深入 Q&A：算法(YATA/墓碑)/Yjs API/持久化/光标/Undo/后端架构
│   │       │   └── Demo逐行讲解.md ← 教程：结合 demo 真实代码逐行讲解 + base64 + diff
│   │       └── WebRTC/       ← 音视频通信（2026-07 新增，与高德地图同归「解决方案」侧边栏分组）
│   │
