import{_ as n,o as a,c as e,ag as p}from"./chunks/framework.ppPvAPr9.js";const u=JSON.parse('{"title":"Vue 面试题","description":"","frontmatter":{},"headers":[],"relativePath":"interview/Vue/vue.md","filePath":"interview/Vue/vue.md"}'),t={name:"interview/Vue/vue.md"};function l(o,s,i,r,c,d){return a(),e("div",null,[...s[0]||(s[0]=[p(`<h1 id="vue-面试题" tabindex="-1">Vue 面试题 <a class="header-anchor" href="#vue-面试题" aria-label="Permalink to &quot;Vue 面试题&quot;">​</a></h1><h2 id="vue-响应式原理" tabindex="-1">Vue 响应式原理 <a class="header-anchor" href="#vue-响应式原理" aria-label="Permalink to &quot;Vue 响应式原理&quot;">​</a></h2><h3 id="核心一句话" tabindex="-1">核心一句话 <a class="header-anchor" href="#核心一句话" aria-label="Permalink to &quot;核心一句话&quot;">​</a></h3><blockquote><p><strong>Vue 3 的响应式系统基于 **<strong>ES6 Proxy</strong> 拦截数据的读写操作，配合</strong>依赖收集<strong>和</strong>派发更新**机制，实现数据变化时自动驱动视图更新。</p></blockquote><hr><h3 id="三个核心模块" tabindex="-1">三个核心模块 <a class="header-anchor" href="#三个核心模块" aria-label="Permalink to &quot;三个核心模块&quot;">​</a></h3><p><strong>1. <strong><code>reactive</code></strong> — 数据劫持</strong></p><p>**用 **<code>Proxy</code> 包裹原始对象，拦截 <code>get</code> / <code>set</code> 操作：</p><ul><li><code>get</code> 时：收集依赖（谁用了这个数据）</li><li><code>set</code> 时：派发更新（通知用到这个数据的地方重新执行）</li></ul><p><strong>2. <strong><code>Dep</code></strong> — 依赖管理</strong></p><p>**每个响应式属性都对应一个 **<code>Dep</code> 实例，内部用 <code>Set</code> 存储所有订阅它的副作用函数（<code>effect</code>）：</p><ul><li><code>depend()</code>：收集当前正在运行的 <code>activeEffect</code></li><li><code>notify()</code>：遍历 <code>Set</code>，重新执行所有 <code>effect</code></li></ul><p><strong>3. <strong><code>watchEffect</code></strong> — 副作用调度</strong></p><p>**执行副作用函数前，将其赋值给全局变量 **<code>activeEffect</code>；函数执行时内部访问到响应式数据，自动触发 <code>get</code> → <code>dep.depend()</code>，完成订阅；执行完后清空 <code>activeEffect</code>。</p><h2 id="有使用过vue吗-说说你对vue的理解" tabindex="-1">有使用过vue吗？说说你对vue的理解 <a class="header-anchor" href="#有使用过vue吗-说说你对vue的理解" aria-label="Permalink to &quot;有使用过vue吗？说说你对vue的理解&quot;">​</a></h2><p><strong>Vue是一款构建用户界面的JavaScript框架</strong></p><p>**特点： **</p><ul><li><strong>MVVM 数据驱动</strong> ** <strong>model 模型层，负责处理业务逻辑以及和服务器端进行交互</strong> ** <strong>view 视图层， 负责将数据模型转化为UI展示出来，可以简单的理解为HTML页面</strong> ** **v-model 视图模型层，用来连接Model和View，是Model和View之间的通信桥梁</li><li><strong>组件化</strong></li><li>**指令系统 **<strong>如何实现自定义指令</strong></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    // 在 Vue 实例中注册全局自定义指令</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span>    &lt;/script&gt;</span></span></code></pre></div><ul><li><strong>通过Vuex进行通信</strong> ** **vuex详解：</li><li><strong>通过浏览器存储</strong></li><li><strong>通过事件总线或订阅发布进行通信</strong></li></ul><h3 id="完整数据流" tabindex="-1">完整数据流 <a class="header-anchor" href="#完整数据流" aria-label="Permalink to &quot;完整数据流&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>watchEffect(fn)</span></span>
...
<span class="line"><span>             }</span></span>
<span class="line"><span>         }</span></span>
<span class="line"><span>     }</span></span></code></pre></div><ol start="4"><li><strong>服务端进行请求转发</strong></li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    var express = require(&#39;express&#39;);</span></span>
...
<span class="line"><span>                        }));</span></span>
<span class="line"><span>    module.exports = app</span></span></code></pre></div><ol start="5"><li><strong>nginx实现代理</strong></li></ol><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    server {</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="vue项目本地开发完成后部署到服务器后报404是什么原因呢" tabindex="-1">vue项目本地开发完成后部署到服务器后报404是什么原因呢？ <a class="header-anchor" href="#vue项目本地开发完成后部署到服务器后报404是什么原因呢" aria-label="Permalink to &quot;vue项目本地开发完成后部署到服务器后报404是什么原因呢？&quot;">​</a></h2><h2 id="你是怎么处理vue项目中的错误的" tabindex="-1">你是怎么处理vue项目中的错误的？ <a class="header-anchor" href="#你是怎么处理vue项目中的错误的" aria-label="Permalink to &quot;你是怎么处理vue项目中的错误的？&quot;">​</a></h2><h2 id="vue3有了解过吗-能说说跟vue2的区别吗-新特性" tabindex="-1">vue3有了解过吗？能说说跟vue2的区别吗(新特性)？ <a class="header-anchor" href="#vue3有了解过吗-能说说跟vue2的区别吗-新特性" aria-label="Permalink to &quot;vue3有了解过吗？能说说跟vue2的区别吗(新特性)？&quot;">​</a></h2><ol><li><strong>composition API</strong></li><li><strong>SFC ComPosition API 语法糖</strong></li></ol><p><strong>框架层面</strong></p><ol><li><strong>基于Proxy的响应式系统</strong></li><li></li></ol><h2 id="选项式api与组合式api" tabindex="-1">选项式API与组合式API <a class="header-anchor" href="#选项式api与组合式api" aria-label="Permalink to &quot;选项式API与组合式API&quot;">​</a></h2><h2 id="ref和reactive" tabindex="-1">ref和reactive <a class="header-anchor" href="#ref和reactive" aria-label="Permalink to &quot;ref和reactive&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>- 作用</span></span>
<span class="line"><span>- 源码实现</span></span>
<span class="line"><span>    - ref</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    - reactive</span></span></code></pre></div><h2 id="生命周期" tabindex="-1">生命周期 <a class="header-anchor" href="#生命周期" aria-label="Permalink to &quot;生命周期&quot;">​</a></h2><h2 id="watch和computed" tabindex="-1">watch和computed <a class="header-anchor" href="#watch和computed" aria-label="Permalink to &quot;watch和computed&quot;">​</a></h2><h2 id="组件通信" tabindex="-1">组件通信 <a class="header-anchor" href="#组件通信" aria-label="Permalink to &quot;组件通信&quot;">​</a></h2><ul><li><strong>父子通信</strong> ** **props、emit、ref、$parent</li><li><strong>兄弟组件通信</strong> ** **事件总线、第三方</li><li><strong>边界知识： provide/inject/$attrs</strong></li><li><strong>VueX、浏览器存储（共享信息）</strong></li></ul><p><strong>关于provide注意</strong></p><p><strong>provide的第二个参数作为导出的值可以是任意参数(非相响应式或响应式)</strong> ** <strong>provide只能够向下进行传递数据</strong> ** <strong>在使用provide和inject的时候需从vue中引入</strong></p><h2 id="路由" tabindex="-1">路由 <a class="header-anchor" href="#路由" aria-label="Permalink to &quot;路由&quot;">​</a></h2><h2 id="快速上手vuex-到-手写简易-vuex" tabindex="-1">快速上手Vuex 到 手写简易 Vuex <a class="header-anchor" href="#快速上手vuex-到-手写简易-vuex" aria-label="Permalink to &quot;快速上手Vuex 到 手写简易 Vuex&quot;">​</a></h2><p><strong>使用VueX的好处</strong></p><ul><li><strong>能够在VueX集中管理数据，易于开发和后期维护</strong></li><li><strong>能够高效地实现组件之间的数据共享，提高开发效率</strong></li><li><strong>在 vuex 中的数据都是响应式的</strong> ** **VueX的基础使用</li><li><strong>state</strong> ** <strong>存放数据</strong> ** <strong>取state两种方式:</strong></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    this.$store.state.perportyName</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    ...mapState([perpoetyName1,perportyName2])</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>- 方式一</span></span>
<span class="line"><span>- 方式二</span></span></code></pre></div><ul><li><strong>mutation</strong> ** <strong>Store 中的状态不能直接对其进行操作，我们得使用 Mutation 来对 Store 中的状态进行修改，虽然看起来有些繁琐，但是方便集中监控数据的变化</strong> ** <strong>state的更新必须是Mutation来处理</strong> ** **两种触发方式 <ul><li><strong>方式一</strong></li></ul></li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    this.$store.commit(funName)</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>- 方式二</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    ...mapMutations([funName1,funName2])</span></span></code></pre></div><ul><li><strong>action</strong> ** <strong>异步调用的方式</strong> ** <strong>action =&gt; mutation =&gt; state</strong> ** **调用方式</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    this.$store.dispatch()</span></span></code></pre></div><p>** 方式二**</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    mapAction([actionFun1,actionFun2])</span></span></code></pre></div><ul><li><strong>getter</strong> ** **Getter类似于计算属性，但是我们的数据来源是state</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    state: {</span></span>
...
<span class="line"><span>            }</span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>    }</span></span></code></pre></div><p>** 组件引入方式**</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    this.$store.getters.myname</span></span></code></pre></div><p>** 第二种**</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    mapGetters([&#39;myname&#39;])</span></span></code></pre></div><ul><li><strong>module</strong> ** **state数据过多时，就会变得难以管理，VueX允许将store分成不同的模块，每个模块都有属于自己的state等</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    const state = {}</span></span>
...
<span class="line"><span>        getter</span></span>
<span class="line"><span>    }</span></span></code></pre></div><p>** index.js**</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    import Home from &#39;./Home&#39;</span></span>
...
<span class="line"><span>    }, 2000);</span></span></code></pre></div><h2 id="最长递增子序列" tabindex="-1">最长递增子序列 <a class="header-anchor" href="#最长递增子序列" aria-label="Permalink to &quot;最长递增子序列&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/**</span></span>
...
<span class="line"><span>    }</span></span>
<span class="line"><span>    return result</span></span>
<span class="line"><span>}</span></span></code></pre></div>`,254)])])}const h=n(t,[["render",l]]);export{u as __pageData,h as default};
