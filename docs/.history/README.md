...
- Deprecated: `docs/.progress/{username}.md`
- Target: `docs/.history/{username}.json`
...
4. Append knowledge inject event:
	...
	powershell
	.\docs\interview\.history\history.ps1 -Username hegui -EventType kb.inject -Topic TypeScript -Title "Inject conditional types Q&A" -Source kb-inject -DetailsJson "{\"target\":\"docs/frontend/Ts/index.md\",\"operation\":\"enhance\"}"
