...
const backendSidebar = [
  ...
  },
  {
    ...
    collapsed: false,
    items: [
      { text: 'Redis 速通', link: '/interview/Redis/' },
    ],
  },
  {
    text: '🟢 Node.js 服务端',
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      ...
      '/interview/MySQL/': backendSidebar,
      '/interview/Redis/': backendSidebar,
