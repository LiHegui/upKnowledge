...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>在Gatsby构建过程中，GraphQL查询从原始源中提取出来进行解析</strong></p><ol start="3"><li>如何向页面查询添加查询变量</li></ol>`,10),o=[p];function i(l,c){return n(),a("div",null,o)}const d=s(t,[["render",i],["__file","QueryingData.html.vue"]]),u=JSON.parse('{"path":"/tools/docs/repository/Gastby/QueryingData.html","title":"查询数据","lang":"zh-CN","frontmatter":{},"headers":[],"git":{},"filePathRelative":"tools/docs/repository/Gastby/QueryingData.md"}');export{d as comp,u as data};
