import{_ as e,o as n,c as i,e as a}from"./app-BzfR_7FA.js";const l={},s=a(`<h1 id="说说你对webpack的理解-解决了什么问题" tabindex="-1"><a class="header-anchor" href="#说说你对webpack的理解-解决了什么问题"><span>说说你对webpack的理解？解决了什么问题？</span></a></h1><p>webapck的最初目标是实现前端的模块化，旨在更高效地管理和维护项目中的每一个资源。</p><h1 id="说说webpack的构建流程" tabindex="-1"><a class="header-anchor" href="#说说webpack的构建流程"><span>说说webpack的构建流程?</span></a></h1><p>webpack的运行流程就是一个串行的过程，它的工作流程就是将各个插件串联起来。</p><ul><li>初始化流程:从配置文件和shell语句读取与合并参数，并初始化需要的内置的和配置的插件以及执行环境所需要的参数</li><li>编译构建流程：从入口文件entry出发，针对每个module模块串行调用loader去编译文件，再找到module依赖的module，递归地进行编译处理 -对编译后地module组合成chunk，把chunk转换成文件，输出到指定出口文件目录</li><li>在整个过程中，webpack会广播各种事件，而插件只需要监听它所关心的事件，就能加入到这条webpack机制中，然后改变webpack的运作，使整个系统的拓展性很好</li></ul><h1 id="说说webpack的热更新是如何做到的-原理是什么" tabindex="-1"><a class="header-anchor" href="#说说webpack的热更新是如何做到的-原理是什么"><span>说说webpack的热更新是如何做到的？原理是什么？</span></a></h1><p>热更新的配置项为HMR默认就是为true 指在应用程序中，替换、添加、删除模块，无需重新刷新整个应用。</p><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li>plugin plugin模块用来扩展webpack的功能 <ul><li>HtmlWebpackPlugin 以html为模板，最终打包进入html</li><li>CleanWebpackPlugin 抽离成单独的css文件</li></ul><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>module.exports = {
    plugins: [
...
</code></pre>`,34),t=[s];function c(d,p){return n(),i("div",null,t)}const o=e(l,[["render",c],["__file","index.html.vue"]]),u=JSON.parse('{"path":"/tools/docs/interview/Webpack/","title":"说说你对webpack的理解？解决了什么问题？","lang":"zh-CN","frontmatter":{},"headers":[{"level":2,"title":"实现原理","slug":"实现原理","link":"#实现原理","children":[]}],"git":{"updatedTime":1724126230000,"contributors":[{"name":"LiHegui","email":"1487647822@qq.com","commits":1}]},"filePathRelative":"tools/docs/interview/Webpack/index.md"}');export{o as comp,u as data};
