import{_ as s,o as n,c as a,e}from"./app-BzfR_7FA.js";const t={},p=e(`<h1 id="查询数据" tabindex="-1"><a class="header-anchor" href="#查询数据"><span>查询数据</span></a></h1><h1 id="使用graphql查询页面中的数据" tabindex="-1"><a class="header-anchor" href="#使用graphql查询页面中的数据"><span>使用GraphQL查询页面中的数据</span></a></h1><p>我们来简单使用一下</p><ol><li>添加description到siteMetadata</li></ol><p>gatsby-config.js</p><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code>module<span class="token punctuation">.</span>exports <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>在Gatsby构建过程中，GraphQL查询从原始源中提取出来进行解析</strong></p><ol start="3"><li>如何向页面查询添加查询变量</li></ol>`,10),o=[p];function i(l,c){return n(),a("div",null,o)}const d=s(t,[["render",i],["__file","QueryingData.html.vue"]]),u=JSON.parse('{"path":"/tools/docs/repository/Gastby/QueryingData.html","title":"查询数据","lang":"zh-CN","frontmatter":{},"headers":[],"git":{"updatedTime":1724126230000,"contributors":[{"name":"LiHegui","email":"1487647822@qq.com","commits":1}]},"filePathRelative":"tools/docs/repository/Gastby/QueryingData.md"}');export{d as comp,u as data};
