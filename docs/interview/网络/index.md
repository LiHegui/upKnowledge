...
在面试中回答“对 WebSocket 的理解”时，可以从**基础概念、核心特点、与 HTTP 的关系、典型应用场景、以及工程实践中的关键设计**这几个层面来展开。下面整理了一份结构清晰、重点突出的回答框架，你可以根据实际情况适当调整深度。
...
在面试时，你可以先简洁地给出定义和特点，然后结合自己项目中的具体实践，聊聊心跳重连的设计，这样既能体现技术深度，也能展示工程落地能力。
